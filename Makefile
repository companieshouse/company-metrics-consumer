...
docker/kafka-create-topics:
	...
	@kafka-topics --create   --bootstrap-server localhost:29092   --replication-factor 1 --partitions 1   --topic company-metrics
	@kafka-topics --create   --bootstrap-server localhost:29092   --replication-factor 1 --partitions 1   --topic company-metrics-retry
	@kafka-topics --create   --bootstrap-server localhost:29092   --replication-factor 1 --partitions 1   --topic company-metrics-error
	@printf "\nKafka Topics:\n\n"
